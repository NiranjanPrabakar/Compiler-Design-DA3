...
define dso_local void @_Z8multiplyPA3_iS0_S0_([3 x i32]* noundef %0, [3 x i32]* noundef %1, [3 x i32]* noundef %2) #4 {
...
define dso_local noundef i32 @main() #5 {
  ...
  %7 = bitcast [3 x [3 x i32]]* %2 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %7, i8* align 16 bitcast ([3 x [3 x i32]]* @__const.main.A to i8*), i64 36, i1 false)
  %8 = bitcast [3 x [3 x i32]]* %3 to i8*
  call void @llvm.memcpy.p0i8.p0i8.i64(i8* align 16 %8, i8* align 16 bitcast ([3 x [3 x i32]]* @__const.main.B to i8*), i64 36, i1 false)
  %9 = getelementptr inbounds [3 x [3 x i32]], [3 x [3 x i32]]* %2, i64 0, i64 0
  %10 = getelementptr inbounds [3 x [3 x i32]], [3 x [3 x i32]]* %3, i64 0, i64 0
  %11 = getelementptr inbounds [3 x [3 x i32]], [3 x [3 x i32]]* %4, i64 0, i64 0
  call void @_Z8multiplyPA3_iS0_S0_([3 x i32]* noundef %9, [3 x i32]* noundef %10, [3 x i32]* noundef %11)
